...
`;
            ...
            const classExport = result.exports.find(e => e.name === 'TestClass');
            if (classExport?.members) {
                const memberNames = classExport.members.map(m => m.name);
                expect(memberNames).toContain('public_method');
...
`;
            ...
            const options: ProcessingOptions = {
                excludePatterns: ['*admin*', '*Admin*', 'TEST_*']
            };
...
`;
            ...
            const funcExport = result.exports.find(e => e.name === 'complex_function');
...
`;
            ...
            const asyncFunc = result.exports.find(e => e.name === 'async_function');
            expect(asyncFunc?.signature).toContain('async def');
            
            const classExport = result.exports.find(e => e.name === 'MyClass');
            const asyncMethod = classExport?.members?.find(m => m.name === 'async_method');
...
`;
            ...
            const outerClass = result.exports.find(e => e.name === 'OuterClass');
            ...
            const topFunc = result.exports.find(e => e.name === 'top_level_function');
